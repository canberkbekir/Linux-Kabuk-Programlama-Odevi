...
--add-entry "CV arkaplan renk kodu:" \
...
<head>
     ...
     <style type="text/css">
        * { margin: 0; padding: 0; }
        body { font: 16px Helvetica, Sans-Serif; line-height: 24px; background-color: #$renk }
        .clear { clear: both; }
        ...
        #objective p { font-family: Georgia, Serif; font-style: italic; color: #999; }
